...
//   console.log(`${name} é um gato ${color} de IDADE_DO_GATO anos`)
...
crazyArray.shift()
  ...
  */
  ...
  const nameDog = dogs.find(item => item.name === "Zequinha")
  console.log(nameDog)
  ...
  */
 const titleReference = document.querySelectorAll('.secondary-title')
