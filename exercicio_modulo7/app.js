...
for(let i=0; i < randomNumbers.length;i++){
    ...
    if(total > limite){
        console.log(`A soma ultrapassou limite. Até aqui, o valor atual é ${total}`)
        break
    }
}
...
switch(drinkType){
    ...
    default:
            ...
            drinkMessage = 'Teste também as outras possibilidades de tipo  da bebida além da que você escolheu'
}
