...
// const url2 = 'https://pokeapi.co/api/v2/pokemon/4'
// const url3 = 'https://pokeapi.co/api/v2/pokemon/7'
...
//     if (isRequestNotOk) {
//       callback('Não possivel fazer a requisição', null)
//     }
//   })
...
// getPokemon(url, (error, data) => {
//   logPokemondata(error, data)
//   getPokemon(url2, (error, data) => {
//     logPokemondata(error, data)
//     getPokemon(url3, (error, data) => {
//       logPokemondata(error, data)
//     })
//   })
// })
