...
//         console.log('Não possivel fazer a requisição')
//     }
// })
...
pessoa.walkOnTheStreet = meters => {
    pessoa.youRunning = true
    pessoa.howMuchMetersYouWalk += meters
}

const meters = [7, 13, 15, 20]
meters.forEach(meter => {
    pessoa.walkOnTheStreet(meter)
})
...
const getPuralOrSingular = (quantity, singular, plural) => 
...
const valueTruthy = value => Boolean(value)
...
truthyValues.forEach(truthyValue => {
  console.log(valueTruthy(truthyValue))
})
