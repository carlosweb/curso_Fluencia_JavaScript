...
const my3FavoriteTVShows = ['Lagoa Azul', 'Hangover', 'Vida Loka']

const sentence = `Minhas ${my3FavoriteTVShows.length} séries favoritas são: ${my3FavoriteTVShows.join(', ')}.`
.replace(', V', ' e V')
...
const typeSentence = `isRandomTVShowIncluded" armazena é: ${typeof(isRandomTVShowIncluded)}` 
