...
const btstopCounter = document.querySelector('.button-stop-counter')
const displayNumber = document.querySelector('.counter-container')

let timer = null

const incrementCounter = () => {
    const incrementedCounter = Number(displayNumber.textContent) + 1
    displayNumber.textContent = incrementedCounter
}
